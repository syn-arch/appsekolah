        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <div class="box-title">
                        <a href="<?php echo base_url('tugas') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                    </div>
                </div>
            </div>
            <div class="box-body">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group <?php if(form_error('id_guru')) echo 'has-error'?> ">
                            ...
                            <?php if ($this->session->userdata('level') == 'Admin'): ?>
                                ...
                                <?php else : ?>
                                    <?php $id_guru = $this->db->get('guru', ['id_user' => $this->session->userdata('id_user') ])->row()->id_guru; ?>
